<div class='container e404 medium-width escuelas'>
	...
	<?php if($this->suggestion){?>
		...
		<a href="/escuelas/index/<?=$this->escuela->cct?>" class="button-bordered suggestion">
			...
			<p><img src="/templates/mtev2/img/error404/pinmap.png" alt=""><?=$this->escuela->entidad->nombre?></p>
			<p><img src="/templates/mtev2/img/error404/turno.png" alt=""><?=$this->capitalize($this->escuela->turno->nombre)?></p>
		</a>
	<?php } ?>
